...
const projects: Project[] = [
  ...
  {
    slug: "keragon-healthcare-automation",
    title: "Keragon – HIPAA-Compliant Healthcare Workflow Automation Platform",
    role: "Full-Stack Developer · AI Integration · Workflow Architecture · SaaS Engineering",
    category: "SaaS",
    filterSlugs: ["saas", "fullstack"],
    highlight: "Healthcare SaaS Platform",
    description:
      "Production healthcare automation SaaS - HIPAA-compliant workflow orchestration, deterministic rules engine, 300+ EHR integrations, and AI-assisted automation for clinical and operational teams.",
    longDescription:
      "Built and scaled a HIPAA-compliant healthcare workflow automation platform trusted by 500+ healthcare organizations. The platform enables clinical and operations teams to orchestrate multi-step workflows across 300+ integrations including leading EHRs (Athenahealth, ModMed, Healthie), CRMs, billing tools, and communication platforms. Core architecture includes a deterministic rules engine with conditional if/else logic, custom data mapping, webhook-first integrations, and JQ-based custom code functions. AI-assisted workflow generation allows users to describe automations in plain English and have the system build, validate, and deploy them. Built on Next.js, TypeScript, and PostgreSQL with SOC2 Type II and HIPAA compliance, AES-256 encryption, audit logging, SSO, and role-based access controls.",
    tech: [
      "Next.js",
      "TypeScript",
      "PostgreSQL",
    ...
    tags: ["Healthcare", "HIPAA", "SaaS", "Workflow Automation"],
    gradient: "from-teal-600/20 to-emerald-600/20",
    liveUrl: "https://www.keragon.com/",
    images: [
      "/images/keragon-1.jpg",
      "/images/keragon-2.jpg",
      "/images/keragon-3.jpg",
      "/images/keragon-4.jpg",
      "/images/keragon-5.jpg",
    ],
    highlights: [
      "Deterministic rules engine with conditional if/else logic, filters, delays, loops, and custom JQ expressions",
      "300+ native healthcare integrations including Athenahealth, ModMed, Healthie, DrChrono, Twilio, Stripe, and PostgreSQL",
      "AI-assisted workflow builder - users describe automations in plain English and the system builds, maps, and deploys them",
      "SOC2 Type II & HIPAA compliance with AES-256 encryption, BAAs, audit trails, SSO, and 7-day data retention policy",
      "AI Agents for healthcare ops - automated patient intake, appointment reminders, and no-show recovery workflows",
      "Scaled to 20M+ workflow executions across 500+ healthcare organizations from solo clinics to NASDAQ-listed companies",
    ],
  },
  {
