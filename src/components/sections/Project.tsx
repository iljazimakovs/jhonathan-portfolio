...
const projects: Project[] = [
  ...
  {
    slug: "alkemi-slack-analytics-agent",
    title: "Alkemi – Conversational Business Analytics Agent for Slack",
    role: "AI Engineer · LLM Integration · Slack Bot Development · Data Pipeline Architecture",
    category: "AI",
    filterSlugs: ["ai", "saas", "fullstack"],
    highlight: "AI Slack Data Agent",
    description:
    ...
    tags: ["AI Agent", "Slack Integration", "LLM", "Business Intelligence"],
    ...
    highlights: [
      ...
      "Shipped real-time chart and summary generation directly into Slack threads, eliminating dashboard context-switching for the team",
    ],
  },
  {
    slug: "brev-okr-agent-platform",
    title: "Brev – AI Agents for OKR Tracking & Team Accountability",
    role: "AI Automation Engineer · Agent Development · LLM Integration · Workflow Automation",
    category: "AI",
    filterSlugs: ["ai", "saas", "fullstack"],
    highlight: "AI OKR & Accountability Agents",
    description:
    ...
    tags: ["AI Agents", "OKR Tracking", "Accountability", "Workflow Automation"],
    ...
    liveUrl: "https://getbrev.ai",
    highlights: [
      "Continuous OKR tracking agents pulling live progress signals from dozens of connected tools and data sources",
      "Risk identification layer detecting goal and KPI threats automatically before they reach leadership review cycles",
      "Data silo elimination architecture unifying fragmented performance data across teams into a single visibility layer",
      "Weekly accountability recap agents coaching teams on execution gaps and next actions without manual reporting",
      "Automation pipeline reducing 30+ hours per week of manual tracking and coordination overhead per leadership team",
      "Agents built with human-in-the-loop controls, monitoring, and error handling for reliable production deployment",
    ],
  },
  {
    slug: "pitchbooking-platform",
    title: "Pitchbooking – Sports Facility Booking & Management Platform",
    role: "Full-Stack Developer · Google Calendar Integration · OAuth Architecture · Supabase Edge Functions · Payments Integration",
    category: "SaaS",
    filterSlugs: ["saas", "fullstack"],
    ...
    tags: ["SaaS", "Sports", "Google OAuth", "Calendar Integration"],
